...
public class WorldGenDungeonsMixin extends WorldGenerator {
    private static final StructurePieceTreasure[] field_111189_a = new StructurePieceTreasure[]{
            ...
            new StructurePieceTreasure(Items.morningStarCopper.itemID, 0, 1, 1, 1),
            new StructurePieceTreasure(Items.warHammerRustedIron.itemID, 0, 1, 1, 2),
            new StructurePieceTreasure(Items.morningStarRustedIron.itemID, 0, 1, 1, 2),
            new StructurePieceTreasure(Items.ignitionRustedIron.itemID, 0, 1, 1, 1),};
    private static final StructurePieceTreasure[] chest_contents_for_underworld = new StructurePieceTreasure[]{
            ...
            new StructurePieceTreasure(Items.morningStarAncientMetal.itemID, 0, 1, 1, 2),
            new StructurePieceTreasure(Items.ignitionAncientMetal.itemID, 0, 1, 1, 2)};
    @Shadow
