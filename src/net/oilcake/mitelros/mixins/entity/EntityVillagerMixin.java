        ...
        switch (this.getProfession()) {
            ...
            case 2:
                ...
                if (this.rand.nextFloat() < this.adjustProbability(0.2F)) {
                    var2.add(new MerchantRecipe(new ItemStack(Items.AncientmetalArmorPiece.itemID, 12 + rand.nextInt(4)), new ItemStack(Item.emerald.itemID, 1, 0)));
                }
            ...
            case 4:
                ...
                if (this.rand.nextFloat() < this.adjustProbability(0.25F)) {
                    var2.add(new MerchantRecipe(new ItemStack(Items.horse_meat, 4 + rand.nextInt(2)), new ItemStack(Item.emerald.itemID, 1, 0)));
                }
                if (this.rand.nextFloat() < this.adjustProbability(0.5F)) {
                    var2.add(new MerchantRecipe(new ItemStack(Item.emerald, 1), new ItemStack(Items.horse_meat_cooked.itemID, 5 + rand.nextInt(2), 0)));
                }
                if (this.rand.nextFloat() < this.adjustProbability(0.25F)) {
                    var2.add(new MerchantRecipe(new ItemStack(Item.bowlEmpty,4), new ItemStack(Item.emerald, 1 + rand.nextInt(1)), new ItemStack(Item.bowlMilk.itemID, 4 + rand.nextInt(1),0)));
                }
                if (this.rand.nextFloat() < this.adjustProbability(0.25F)) {
                    var2.add(new MerchantRecipe(new ItemStack(Items.claybowlEmpty,4), new ItemStack(Item.emerald, 1 + rand.nextInt(1)), new ItemStack(Items.claybowlMilk.itemID, 4 + rand.nextInt(1),0)));
                }
                if (this.rand.nextFloat() < this.adjustProbability(0.25F)) {
                    var2.add(new MerchantRecipe(new ItemStack(Item.bucketCopperEmpty,1), new ItemStack(Item.emerald, 1 + rand.nextInt(1)), new ItemStack(Item.bucketCopperMilk.itemID, 1 + rand.nextInt(1),0)));
                }
                if (this.rand.nextFloat() < this.adjustProbability(0.25F)) {
                    var2.add(new MerchantRecipe(new ItemStack(Item.bucketIronEmpty,1), new ItemStack(Item.emerald, 1 + rand.nextInt(1)), new ItemStack(Item.bucketIronMilk.itemID, 1 + rand.nextInt(1),0)));
                }
        }
