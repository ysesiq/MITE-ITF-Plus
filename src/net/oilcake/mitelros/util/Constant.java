...
public class Constant {
    public static final String VERSION = " P09 ";
...
//    public static final bjo inventory = new bjo("textures/gui/inventory.png");
    public static final int VER_NUM = 118;
    ...
    public static int CalculateCurrentDiff(){
        ...
        if(StuckTagConfig.TagConfig.TagLoseBearings.ConfigValue) Diff += 1;
        ...
        if(StuckTagConfig.TagConfig.TagDemonDescend.ConfigValue) Diff += 2;
        ...
        if(StuckTagConfig.TagConfig.TagDimensionInvade.ConfigValue) Diff += 4;
        if(StuckTagConfig.TagConfig.TagRejection.ConfigValue) Diff += 2;
        if(StuckTagConfig.TagConfig.TagUnstableExplosion.ConfigValue) Diff += 1;
