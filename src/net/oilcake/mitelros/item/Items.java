...
public class Items extends Item {
    ...
    public static final ItemPieces pieceAdamantium = (ItemPieces) (new ItemPieces(Constant.getNextItemID(), Materials.orePieces, "pieceAdamantium"));    public static final ItemFood mashedCactus = (ItemFood) (new ItemFood(Constant.getNextItemID(), Materials.mashedCactus,1, 0,false,true,false,"mashedCactus")).setMaxStackSize(4);
    ...
    public static final ItemArmor bootsCustom_b = new ItemBoots(Constant.getNextItemID(),Materials.custom_b,false);    public static final ItemFishingRod fishingRodNickel = (ItemFishingRod)(new ItemFishingRod(Constant.getNextItemID(), Materials.nickel)).setUnlocalizedName("fishingRod");
    ...
    public static final ItemMorningStar morningStarRustedIron= new ItemMorningStar(Constant.getNextItemID(), Material.rusted_iron);
    ...
    public static final ItemBucket woodBucketEmpty = (ItemBucket) new ItemBucket(Constant.getNextItemID(), Materials.wood,null);
    public static final ItemBucket woodBucketWater = (ItemBucket) new ItemBucket(Constant.getNextItemID(), Materials.wood,Materials.water).setContainerItem(woodBucketEmpty);
    public static final ItemBucket woodBucketWaterSuspicious = (ItemBucket) new ItemBucket(Constant.getNextItemID(), Materials.wood,Materials.unsafe_water).setContainerItem(woodBucketEmpty);
    public static final ItemBucket woodBucketWaterSwampland = (ItemBucket) new ItemBucket(Constant.getNextItemID(), Materials.wood,Materials.dangerous_water).setContainerItem(woodBucketEmpty);
    public static final yi woodBucketMilk = (yi) new yi(Constant.getNextItemID(), Materials.wood).setContainerItem(woodBucketEmpty);
    public static final ItemHoe hoeFlint = createInstance(ItemHoe.class,new Class[]{int.class,Material.class},Constant.getNextItemID(),Materials.flint);
    public static final ItemFood peeledSugarcane = (new ItemFood(Constant.getNextItemID(), Materials.peeledSugarcane, 0, 1, 1200, false, false, true, "peeledSugarcane")).setPlantProduct();
    ...
    public static final Item totemofsentry = (ItemTotem) (new ItemTotem(Constant.getNextItemID(),Material.adamantium,"totem")).setMaxStackSize(1);
    public static final Item totemofunknow = (ItemTotem) (new ItemTotem(Constant.getNextItemID(),Material.rusted_iron,"totem")).setMaxStackSize(1);
    ...
    public static final ItemIgnition ignitionRustedIron = new ItemIgnition(Constant.getNextItemID(),Material.rusted_iron);
...
//    public static final Item test = (ItemPieces) new ItemPieces(Constant.getNextItemID(), Materials.orePieces, "pieceTungsten1").setPotionEffectC(potionBrewer.getAttackEffect());
        ...
        register("tool/rusted_iron/rusted_iron_club",morningStarRustedIron);
        register("tool/uru/uru_club", UruMorningStar);
        register("buckets/wood/empty",woodBucketEmpty);
        register("buckets/wood/water",woodBucketWater);
        register("buckets/wood/water_suspicious",woodBucketWaterSuspicious);
        register("buckets/wood/water_swampland",woodBucketWaterSwampland);
        register("buckets/wood/milk",woodBucketMilk);
        register("tool/flint/flint_hoe",hoeFlint);
        ...
        register("totem/totem_of_unknow",totemofunknow);
...
//        register("skulls",skulls);
    ...
    public static void registerRecipes(RecipeRegister register) {
        ...
        register.registerShapedRecipe(new ItemStack(woodBucketEmpty, 1), true,
                ...
                " W ",
                'W', Block.wood);
        register.registerShapedRecipe(new ItemStack(hoeFlint, 1), true,
                "FF",
                "SP",
                "S ",
                'F', Item.flint,
        ...
        register.registerShapedRecipe(new ItemStack(hoeFlint, 1), true,
                ...
                'S', Item.stick,
                'P', Item.silk);
        register.registerShapelessRecipe(new ItemStack(peeledSugarcane, 2), false,
                Item.reed, Item.reed
        );
        ...
        register.registerShapelessRecipe(new ItemStack(totemofunknow, 1), true,
                Block.melon, Block.melon, Block.melon,
                Block.melon, Block.melon, Block.melon,
                Block.melon, Block.melon, Block.melon
        );
