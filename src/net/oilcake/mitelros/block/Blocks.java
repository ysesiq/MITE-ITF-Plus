...
public class Blocks extends Block {
    ...
    public static final Block blockSmokerIdle = new BlockSmoker(180, false).setCreativeTab(CreativeModeTab.tabDecorations)
    ...
    public static final Block oreNetherTungsten = new BlockOre(161, Materials.tungsten, 4).setBlockHardness(3.5F).setExplosionResistance(30.0f);
//    public static final Block invisibleLight = new BlockInvisibleLight(160).setBlockLightLevel(0.5F);
    ...
    public static void registerBlocks() {
        ...
        registerItemBlock("ore/nether_tungsten_ore",oreNetherTungsten);
