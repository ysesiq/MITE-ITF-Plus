...
public class MITEisTooFalseMod extends AbstractMod {
    ...
    public InjectionConfig getInjectionConfig() {
        return InjectionConfig.Builder.of("MITE-ITF-Plus", MinecraftMixin.class.getPackage(), MixinEnvironment.Phase.INIT).setRequired().build();
    }

    @Override
    public String modId() {
        return "MITEIsTooFalsePlus"+Constant.VERSION;
    }
