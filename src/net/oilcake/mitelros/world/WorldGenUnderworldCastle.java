...
public class WorldGenUnderworldCastle extends WorldGenerator {
    ...
    public boolean generate(World par1World, Random random, int x, int y, int z) {
        ...
        if (!par1World.isUnderworld() && var6 != Block.stone.blockID)
        {
            ...
            fillBlocksWithMetadata(par1World,x+19,x+19,y,y,z-2,z+2,Block.stairsStoneBrick.blockID,1);
            fillBlocksWithMetadata(par1World,x-2,x+2,y,y,z-19,z-19,Block.stairsStoneBrick.blockID,2);
            fillBlocksWithMetadata(par1World,x-19,x-19,y,y,z-2,z+2,Block.stairsStoneBrick.blockID,0);
            fillBlocksWithMetadata(par1World,x-2,x+2,y,y,z+19,z+19,Block.stairsStoneBrick.blockID,3);
            ...
            par1World.setBlock(x-6,y,z-6,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x+6,y,z+6,Block.stairsStoneBrick.blockID,2,2);
            ...
            fillBlocksWithMetadata(par1World,x-4,x-5,y,y,z-4,z-4,Block.stairsStoneBrick.blockID,3);
            par1World.setBlock(x-4,y,z-5,Block.stairsStoneBrick.blockID,1,2);
            fillBlocksWithMetadata(par1World,x+4,x+5,y,y,z+4,z+4,Block.stairsStoneBrick.blockID,2);
            par1World.setBlock(x+4,y,z+5,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x-6,y,z-7,Block.stairsStoneBrick.blockID,0,3);
            par1World.setBlock(x+6,y,z+7,Block.stairsStoneBrick.blockID,0,2);
            ...
            par1World.setBlock(x+3,y,z+6,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x+3,y,z+8,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x+3,y,z+10,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x+3,y,z+12,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x+6,y,z+3,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x+8,y,z+3,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x+10,y,z+4,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x+13,y,z+4,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x+6,y,z+8,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x+7,y,z+9,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x+8,y,z+9,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x-3,y,z+6,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x-3,y,z+8,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x-3,y,z+10,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x-3,y,z+12,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x-6,y,z+3,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x-8,y,z+3,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x-10,y,z+3,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x-12,y,z+3,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x-3,y,z-6,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x-3,y,z-8,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x-3,y,z-10,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x-3,y,z-12,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x-6,y,z-3,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x-8,y,z-3,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x-10,y,z-4,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x-13,y,z-4,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x-6,y,z-8,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x-7,y,z-9,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x-8,y,z-9,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x+3,y,z-6,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x+3,y,z-8,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x+3,y,z-10,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x+3,y,z-12,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x+6,y,z-3,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x+8,y,z-3,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x+10,y,z-3,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x+12,y,z-3,Block.stairsStoneBrick.blockID,3,2);
            ...
            par1World.setBlock(x+11,y,z+4,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x+12,y,z+4,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x+6,y,z+5,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x+4,y,z+4,Block.cobblestoneWall.blockID);
            ...
            par1World.setBlock(x-11,y,z-4,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x-12,y,z-4,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x-6,y,z-5,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-4,y,z-4,Block.cobblestoneWall.blockID);
            par1World.setBlock(x-3,y,z-6,Block.cobblestoneWall.blockID);
            par1World.setBlock(x-3,y,z-8,Block.cobblestoneWall.blockID);
            par1World.setBlock(x-3,y,z-10,Block.cobblestoneWall.blockID);
            ...
            par1World.setBlock(x+4,y,z+4,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x+4,y,z+5,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x+5,y,z+4,Block.stairsStoneBrick.blockID,6,2);
            par1World.setBlock(x+6,y,z+3,Block.stairsStoneBrick.blockID,6,2);
            par1World.setBlock(x+8,y,z+3,Block.stairsStoneBrick.blockID,6,2);
            par1World.setBlock(x+8,y,z+5,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x+3,y,z+6,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x+3,y,z+8,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x+3,y,z+10,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x+3,y,z+12,Block.stairsStoneBrick.blockID,0,2);
            ...
            par1World.setBlock(x-3,y,z+6,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-3,y,z+8,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-3,y,z+10,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-3,y,z+12,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-6,y,z+3,Block.stairsStoneBrick.blockID,6,2);
            par1World.setBlock(x-8,y,z+3,Block.stairsStoneBrick.blockID,6,2);
            par1World.setBlock(x-10,y,z+3,Block.stairsStoneBrick.blockID,6,2);
            par1World.setBlock(x-12,y,z+3,Block.stairsStoneBrick.blockID,6,2);
            fillBlocksWithMetadata(par1World,x-9,x-9,y,y,z+10,z+11,Block.stoneSingleSlab.blockID,3);
            ...
            par1World.setBlock(x-4,y,z-4,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x-4,y,z-5,Block.stairsStoneBrick.blockID,5,2);
            par1World.setBlock(x-5,y,z-4,Block.stairsStoneBrick.blockID,7,2);
            par1World.setBlock(x-6,y,z-3,Block.stairsStoneBrick.blockID,7,2);
            par1World.setBlock(x-8,y,z-3,Block.stairsStoneBrick.blockID,7,2);
            par1World.setBlock(x-8,y,z-5,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-3,y,z-6,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-3,y,z-8,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-3,y,z-10,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-3,y,z-12,Block.stairsStoneBrick.blockID,1,2);
            ...
            par1World.setBlock(x+6,y,z-3,Block.stairsStoneBrick.blockID,7,2);
            par1World.setBlock(x+8,y,z-3,Block.stairsStoneBrick.blockID,7,2);
            par1World.setBlock(x+10,y,z-3,Block.stairsStoneBrick.blockID,7,2);
            par1World.setBlock(x+12,y,z-3,Block.stairsStoneBrick.blockID,7,2);
            fillBlocksWithMetadata(par1World,x+9,x+9,y,y,z-10,z-11,Block.stoneSingleSlab.blockID,3);
            fillBlocksWithMetadata(par1World,x+8,x+8,y,y,z-11,z-12,Block.stoneSingleSlab.blockID,11);
            par1World.setBlock(x+23,y,z-23,Block.stoneSingleSlab.blockID,11,2);
            par1World.setBlock(x+22,y,z-23,Block.stoneSingleSlab.blockID,3,2);
            ...
            par1World.setBlock(x+7,y,z+8,Block.stairsStoneBrick.blockID,1,2);
            ...
            fillBlocksWithMetadata(par1World,x-2,x-2,y,y,z-10,z-14,Block.stoneSingleSlab.blockID,11);
            fillBlocksWithMetadata(par1World,x-3,x-3,y,y,z-10,z-14,Block.stoneSingleSlab.blockID,3);
            par1World.setBlock(x-7,y,z-8,Block.stairsStoneBrick.blockID,0,2);
            fillBlocksWithMetadata(par1World,x+6,x+6,y,y,z-12,z-13,Block.stoneSingleSlab.blockID,11);
            par1World.setBlock(x+7,y,z-12,Block.stoneSingleSlab.blockID,3,2);
            y++;

            par1World.setBlock(x+6,y,z+8,Block.stairsStoneBrick.blockID,1,2);
            ...
            par1World.setBlock(x-6,y,z-8,Block.stairsStoneBrick.blockID,0,2);
            fillBlocksWithMetadata(par1World,x-1,x-1,y,y,z-10,z-14,Block.stoneSingleSlab.blockID,3);
            fillBlocksWithMetadata(par1World,x,x+3,y,y,z-10,z-14,Block.stoneSingleSlab.blockID,11);
            par1World.setBlock(x+5,y,z-13,Block.stoneSingleSlab.blockID,3,2);
            y++;
            ...
            par1World.setBlock(x+5,y,z+8,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-5,y,z-8,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x-5,y,z+6,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x-5,y,z+7,Block.stairsStoneBrick.blockID,0,2);
            ...
            par1World.setBlock(x-5,y,z-8,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x+5,y,z+8,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x+5,y,z-6,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x+5,y,z-7,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x+7,y,z-6,Block.mobSpawner.blockID);
            var18 = (TileEntityMobSpawner)par1World.getBlockTileEntity(x + 7, y, z - 6);
            if (var18 != null) {
                var18.getSpawnerLogic().setMobID("LongdeadGuardian");
            ...
            fillBlocksWithMetadata(par1World,x-9,x-9,y,y,z-2,z-3,Block.stoneSingleSlab.blockID,3);
            fillBlocksWithMetadata(par1World,x-10,x-10,y,y,z-2,z-3,Block.stoneSingleSlab.blockID,11);
            par1World.setBlock(x-4,y,z+10,Block.stairsStoneBrick.blockID,7,2);
            par1World.setBlock(x-4,y,z+13,Block.stairsStoneBrick.blockID,6,2);
            par1World.setBlock(x+4,y,z-10,Block.stairsStoneBrick.blockID,6,2);
            par1World.setBlock(x+4,y,z-13,Block.stairsStoneBrick.blockID,7,2);
            y++;
            ...
            fillBlocksWithMetadata(par1World,x-11,x-11,y,y,z-2,z-3,Block.stoneSingleSlab.blockID,3);
            fillBlocksWithMetadata(par1World,x-12,x-12,y,y,z-2,z-3,Block.stoneSingleSlab.blockID,11);
            par1World.setBlock(x-4,y,z+11,Block.stairsStoneBrick.blockID,7,2);
            par1World.setBlock(x-4,y,z+12,Block.stairsStoneBrick.blockID,6,2);
            par1World.setBlock(x+4,y,z-11,Block.stairsStoneBrick.blockID,6,2);
            par1World.setBlock(x+4,y,z-12,Block.stairsStoneBrick.blockID,7,2);
            par1World.setBlock(x+19,y,z+13,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x+13,y,z+19,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-19,y,z+13,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x-13,y,z+19,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x-19,y,z-13,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x-13,y,z-19,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x+19,y,z-13,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x+13,y,z-19,Block.stairsStoneBrick.blockID,1,2);
            y++;
            ...
            par1World.setBlock(x-5,y,z-8,Block.stoneSingleSlab.blockID,3,2);
            par1World.setBlock(x-6,y,z-8,Block.stoneSingleSlab.blockID,11,2);
            par1World.setBlock(x+4,y,z+2,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x+4,y,z,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x+4,y,z-2,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x+2,y,z-4,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x,y,z-4,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x-2,y,z-4,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x-4,y,z+2,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-4,y,z,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-4,y,z-2,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x+2,y,z+4,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x,y,z+4,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x-2,y,z+4,Block.stairsStoneBrick.blockID,2,2);
            y++;
            ...
            par1World.setBlock(x+8,y,z-7,Block.stoneSingleSlab.blockID,3,2);
            par1World.setBlock(x-8,y,z-7,Block.stoneSingleSlab.blockID,3,2);
            par1World.setBlock(x,y,z+15,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x,y,z-15,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x+15,y,z,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-15,y,z,Block.stairsStoneBrick.blockID,0,2);
            y++;

            par1World.setBlock(x+5,y,z+2,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x+2,y,z+5,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-5,y,z+2,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x-2,y,z+5,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x-5,y,z-2,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x-2,y,z-5,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x+5,y,z-2,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x+2,y,z-5,Block.stairsStoneBrick.blockID,1,2);
            y++;

            par1World.setBlock(x+5,y,z+1,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x+1,y,z+5,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x-5,y,z+1,Block.stairsStoneBrick.blockID,3,2);
            par1World.setBlock(x-1,y,z+5,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x-5,y,z-1,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x-1,y,z-5,Block.stairsStoneBrick.blockID,0,2);
            par1World.setBlock(x+5,y,z-1,Block.stairsStoneBrick.blockID,2,2);
            par1World.setBlock(x+1,y,z-5,Block.stairsStoneBrick.blockID,1,2);
            par1World.setBlock(x,y,z+5,Block.stairsStoneBrick.blockID,6,2);
            par1World.setBlock(x+5,y,z,Block.stairsStoneBrick.blockID,4,2);
            par1World.setBlock(x,y,z+5,Block.stairsStoneBrick.blockID,7,2);
            par1World.setBlock(x+5,y,z,Block.stairsStoneBrick.blockID,5,2);
            y++;
    ...
    private int getRandomStone(int index){
        return index == 0 ? Block.stoneBrick.blockID : Block.stoneBrick.blockID;
    }
