...
public class BiomeGenUnderworldInFreeze extends BiomeGenUnderworld {
    public BiomeGenUnderworldInFreeze(int id) {
        ...
        if (StuckTagConfig.TagConfig.TagDimensionInvade.ConfigValue) {
            this.spawnableMonsterList.add(new BiomeMeta(EntityRevenant.class, 40, 2, 4));
            this.spawnableMonsterList.add(new BiomeMeta(EntityWitch.class, 10, 1, 2));
            this.spawnableMonsterList.add(new BiomeMeta(EntityInfernalCreeper.class, 20, 1, 2));
            this.spawnableMonsterList.add(new BiomeMeta(EntityDemonSpider.class, 30, 1, 4));
            this.spawnableMonsterList.add(new BiomeMeta(EntityHellhound.class, 30, 1, 4));
            this.spawnableMonsterList.add(new BiomeMeta(EntityEvil.class, 30, 2, 4));
            this.spawnableMonsterList.add(new BiomeMeta(EntityPigZombie.class, 50, 1, 2));
            this.spawnableMonsterList.add(new BiomeMeta(EntityMagmaCube.class, 30, 1, 2));
            this.spawnableMonsterList.add(new BiomeMeta(EntityPigmanLord.class, 5, 1, 2));
            this.spawnableMonsterList.add(new BiomeMeta(EntityPigmanGuard.class, 20, 1, 4));
            this.spawnableMonsterList.add(new BiomeMeta(EntityGhast.class, 30, 1, 2));
            this.spawnableMonsterList.add(new BiomeMeta(EntityEarthElemental.class, 40, 1, 1));
            this.spawnableMonsterList.add(new BiomeMeta(EntityWitherBoneLord.class,5,1,2));
            this.spawnableMonsterList.add(new BiomeMeta(EntityWitherBodyguard.class,10,2,2));
            this.spawnableMonsterList.add(new BiomeMeta(EntityBlackWidowSpider.class,20,2,2));
            this.spawnableMonsterList.add(new BiomeMeta(EntityWoodSpider.class,40,2,4));
